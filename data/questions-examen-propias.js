...
export default [
  ...
  },
  {
    ...
    correctIndex: 1,
    explain:
      "Coulomb: la fuerza crece con el producto de las cargas (q1·q2) y decrece con el cuadrado de la distancia. No confundas «producto de cargas» con «cuadrado de la distancia» en el enunciado.",
    sourceRef:
      "Elaboración propia (2026) · libro oficial 1.ª parte Técnica (electricidad); programa HAREC / electricidad básica.",
  },
  {
    id: "ofic-048",
    part: 1,
  ...
  },
  {
    ...
    correctIndex: 1,
    explain: "El voltímetro mide diferencia de potencial en paralelo (alta impedancia de entrada). En serie mediría corriente, no tensión.",
    sourceRef:
      "Elaboración propia (2026) · libro oficial 1.ª parte Técnica (electricidad); programa HAREC / electricidad básica.",
  },
  {
  ...
  },
  {
    ...
    options: ["Amperios por metro (A/m)", "Voltios por metro (V/m)", "Vatios por ohmio", "Hertzios"],
    correctIndex: 1,
  ...
  },
  {
    ...
    correctIndex: 2,
    explain: "Energía en condensador: W = ½·C·V². Aparece el cuadrado de la tensión; no confundas con P = V·I en vatios.",
    sourceRef:
      "Elaboración propia (2026) · libro oficial 1.ª parte Técnica (electricidad); programa HAREC / electricidad básica.",
  },
  {
  ...
  },
  {
    ...
    correctIndex: 1,
    explain:
      "La radiación de RF se propaga como onda electromagnética: campos eléctrico y magnético variables y perpendiculares a la dirección de propagación. No es corriente continua ni solo sonido en el aire.",
    sourceRef:
      "Elaboración propia (2026) · libro oficial 1.ª parte Técnica (electricidad); programa HAREC / electricidad básica.",
  },
  {
    ...
    options: ["115 V", "230 V", "325 V", "460 V"],
    correctIndex: 2,
