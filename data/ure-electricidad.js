 ...
 * Generado: 2026-05-20 · 45 cargas aleatorias · ids ure-p1-q{sourceId}.
...
export default [
  ...
  },
  {
    ...
    stemFigure: "images/quiz/ure-p1-q182-original.jpg",
    stemFigureAlt: "Figura original URE (ure-p1-q182): ¿Cuál es el tipo de conductor más inmune a las interferencias radiadas?:",
    options: [
      "Fibra óptica",
      "Cable coaxial",
      "Cable paralelo",
  ...
  },
  {
    ...
    stemFigure: "images/quiz/ure-p1-q196-original.jpg",
    stemFigureAlt: "Figura original URE (ure-p1-q196): Cuando se produce una interferencia perjudicial que afecta a la seguridad de la vida humana:",
    options: [
  ...
  },
  {
    ...
    stemFigure: "images/quiz/ure-p1-q242-original.png",
    stemFigureAlt: "Figura original URE (ure-p1-q242): La diferencia de potencial eléctrico se mide en:",
    options: [
      "Vatios",
      "Faradios",
      "Microfaradios",
  ...
  },
  {
    ...
    stemFigure: "images/quiz/ure-p1-q299-original.jpg",
    stemFigureAlt: "Figura original URE (ure-p1-q299): Si aumenta la temperatura en un conductor:",
    options: [
  ...
  },
  {
    ...
    stemFigure: "images/quiz/ure-p1-q300-original.png",
    stemFigureAlt: "Figura original URE (ure-p1-q300): La unidad de medida de intensidad eléctrica es el:",
    options: [
      "Voltio",
      "Vatio",
      "Ohmio",
  ...
  },
  {
    ...
    stemFigure: "images/quiz/ure-p1-q310-original.png",
    stemFigureAlt: "Figura original URE (ure-p1-q310): El siguiente esquema eléctrico corresponde a:",
    options: [
  ...
  },
  {
    ...
    stemFigure: "images/quiz/ure-p1-q318-original.png",
    stemFigureAlt: "Figura original URE (ure-p1-q318): Los llamados “detectores de envolvente” tienen la particularidad de:",
    options: [
  ...
  },
  {
    ...
    stemFigure: "images/quiz/ure-p1-q327-original.jpg",
    stemFigureAlt: "Figura original URE (ure-p1-q327): Para medir la potencia de una señal eléctrica, se emplea un:",
    options: [
      "Vatímetro",
      "Frecuencímetro",
  ...
  },
  {
    ...
    stemFigure: "images/quiz/ure-p1-q371-original.jpg",
    stemFigureAlt: "Figura original URE (ure-p1-q371): La variación momentánea de la intensidad de campo recibida se conoce como:",
    options: [
  ...
  },
  {
    ...
    stemFigure: "images/quiz/ure-p1-q4-original.jpg",
    stemFigureAlt: "Figura original URE (ure-p1-q4): La toma de tierra de una estación:",
    options: [
  ...
  },
  {
    ...
    stemFigure: "images/quiz/ure-p1-q415-original.jpg",
    stemFigureAlt: "Figura original URE (ure-p1-q415): Una batería almacena energía eléctrica mediante un proceso:",
    options: [
      "Químico",
      "Acústico",
      "Mecánico",
  ...
  },
  {
    ...
    stemFigure: "images/quiz/ure-p1-q489-original.jpg",
    stemFigureAlt: "Figura original URE (ure-p1-q489): Indique cual de las siguientes respuestas es falsa:",
    options: [
  ...
  },
  {
    ...
    stemFigure: "images/quiz/ure-p1-q5-original.jpg",
    stemFigureAlt: "Figura original URE (ure-p1-q5): Si un equipo está marcado con las siglas \"EMC\" significa:",
    options: [
  ...
  },
  {
    ...
    stemFigure: "images/quiz/ure-p1-q500-original.jpg",
    stemFigureAlt: "Figura original URE (ure-p1-q500): ¿Qué es un \"resonador de cuarzo\"?:",
    options: [
  ...
  },
  {
    ...
    stemFigure: "images/quiz/ure-p1-q62-original.png",
    stemFigureAlt: "Figura original URE (ure-p1-q62): Una de las técnicas para tratar de eliminar interferencias es el filtrado. Si se utiliza un filtro pasobanda, ¿qué se co",
    options: [
