...
export function synthesizeReason(stem, correct, topicId) {
  ...
  return `Respecto a «${stemBrief}${stem.length > 85 ? "…" : ""}», la opción que cumple el enunciado en el banco es «${c}». Repasa ${topicHint} en el temario si el distractor te confundió.`;
}
