...
const FIGURE_NOUN_RE =
  /\b(esquema|diagrama de bloques|diagrama de radiaci[oó]n|gr[aá]fic[oa]?|señale el diagrama|ilustra)\b|(?:\bfigura\b.*(?:muestra|conectad|corresponde|representa|siguiente|observa))|(?:\b(?:de la|del)\s+figura\b)|(?:siguientes?\s+curvas\b)/i;
