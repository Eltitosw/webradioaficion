...
import { finalizeExplain, inferExplainTopic, synthesizeReason } from "./contextual-explain.mjs";
...
function explainMarcoNormativo(stem, correct) {
  ...
  if (/lf\b|mf\b|hf\b|vhf|uhf|bandas de frecuencia|nomenclatura/.test(s)) {
    return `Cada símbolo ITU agrupa un tramo espectral; LF son frecuencias muy bajas (30–300 kHz en la tabla habitual del examen). La respuesta es «${c}».`;
  }
